...
/**
 * The Latteisto Coffee Machine Class extends the main CoffeeMachine and represents a specific type of
 * coffee machine
 *
 *
 ...
 * @version    Release: 0.1
 */
class LatteistoCoffeeMachine extends CoffeeMachine {
    ...
    public function __construct() {
      ...
      $this->description = "Latteisto";
      $this->drinks = array('latte');
    }
